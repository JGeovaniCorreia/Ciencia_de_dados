...
- Modelo: qual algoritmo foi treinado e suas métricas no hold-out
- Contexto de uso: quem vai usar e qual decisão o modelo apoia
- Custo de erro: FP e FN têm o mesmo custo? qual é pior para o negócio?
- Variáveis sensíveis: há grupos que precisam de análise de fairness?
